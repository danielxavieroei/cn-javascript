var text = 'HELLO WORLDDDDDDDDDDDDDDDDDDDDDDDDDD'
console.log(text)
...
console.log('Hello worlddddddddddddddddddddd')//string
console.log(5+2)//number & aritmetic
console.log(true)//boolean
console.log(false)//boolean

//variable
var fullname = "Daniel Xavier"
var fullname = "Daniel"
...
user('Daniel Xavier', 'daniel@mail.com')
...
document.writeln(user2('Daniel Xavier', 'daniel@mail.com'))
